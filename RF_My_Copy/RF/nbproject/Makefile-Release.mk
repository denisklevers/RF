...
${OBJECTDIR}/_ext/92f1562c/analyzer.o: ../../RF_MyCopy/analyzer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/92f1562c/analyzer.o ../../RF_MyCopy/analyzer.cpp

${OBJECTDIR}/_ext/92f1562c/main.o: ../../RF_MyCopy/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/92f1562c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/92f1562c/main.o ../../RF_MyCopy/main.cpp

${OBJECTDIR}/_ext/92f1562c/simu.o: ../../RF_MyCopy/simu.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/92f1562c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/92f1562c/simu.o ../../RF_MyCopy/simu.cpp

${OBJECTDIR}/_ext/92f1562c/tools.o: ../../RF_MyCopy/tools.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/92f1562c
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/92f1562c/tools.o ../../RF_MyCopy/tools.cpp
